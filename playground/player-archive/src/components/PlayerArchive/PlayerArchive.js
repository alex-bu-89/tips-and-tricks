...
class PlayerArchieve extends Component {
   ...
   */
  renderMain() {
    const playerAviability = this.props.playerAviability;

    return (
      <main className='player-archieve__main container'>
        {
          (
            (playerAviability.data && playerAviability.data.active === 'false')
            || playerAviability.error
          )
              ? <div className='player-archieve__not-available'>Player is not available</div>
              : <PlayerProfile />
        }
      </main>
    );
  ...
  render() {
    return (
      <section className='player-archieve'>
        { this.renderHeader() }
        { this.renderMain() }
        { this.renderFooter() }
      </section>
